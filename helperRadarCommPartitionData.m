function [imdsTrain,pxdsTrain,imdsVal,pxdsVal] = ...
  helperRadarCommPartitionData(imds,pxds,parts)
%helperRadarCommPartitionData Partition training data
%   [IDSTR,PDSTR,IDSVL,PDSVL]=helperRadarCommPartitionData(IDS,PDS,P)
